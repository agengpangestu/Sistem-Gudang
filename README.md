...
- API Document endpoints (Ongoing)
...
| **src/controllers**      | Controller is responsible for receiving and processing incoming requests.
| **src/helpers**      | Helpers for handling error globally messages.
| **src/middlewares**      | Express middlewares which process the incoming requests before handling them down to the routes
| **src/routes**           | Contain all express routes, separated by module/area of application                       
| **src/services**           | Service is responsible for executing business logic |
| **src/types**      | Types helps create applications that are more secure, structured, easy to maintain, and simplify development and refactoring. |
| **src/utils** | Utils are essential components in modern software architecture that help developers in creating organized, structured, and efficient code. |
| **src/validation** | Validation is a fundamental aspect of software development that should not be overlooked |
...
### Using the debugger in VS Code (Ongoing)
...
### Example application.spec.ts (Ongoing)
<!-- ```
